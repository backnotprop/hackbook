...
<!--
	 User data: The users personal data is clearly visable here. Things like email, 
	phone, birthday and home addresses should never just autimatically be availible. Now-a-days
	Social Networks have privacy settings which allow users to hide personal details. The
	flag for this is: WEB-EQWE-912
-->
